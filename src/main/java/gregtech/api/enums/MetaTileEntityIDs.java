...
public enum MetaTileEntityIDs {
    ...
    INPUT_HATCH_ME(2717),
    INPUT_BUS_ME(2718),
    INPUT_BUS_PATTERN_PROVIDER_IV(2719),
    INPUT_BUS_PATTERN_PROVIDER_LuV(2720),
    INPUT_BUS_PATTERN_PROVIDER_ZPM(2721),
    INPUT_BUS_PATTERN_PROVIDER_UV(2722),
    INPUT_BUS_PATTERN_PROVIDER_UHV(2723),
    INPUT_HATCH_ME_LONG(2724),
    ...
    HATCH_BEAMLINE_INPUT(10503),
    HATCH_BEAMLINE_OUTPUT(10504),
    ...
    BoseEinsteinCondensatePipe(15475),
    BoseEinsteinCondensateHatch(15476),
    BoseEinsteinCondensatePipeBlock(15477),
    ...
    BoseEinsteinCondensateGenerator(15754),
    BoseEinsteinCondensateStorage(15755),
    BoseEinsteinCondensateAssembler(15756),
    BoseEinsteinCondensateIONode(15757),
    HatchNaniteDetector(15758),
    HatchIOController(15759),
    BoseEinsteinCondensateDiode(15760),
    HatchCondensateDetector(15761),
    ...
    LARGE_NEUTRALIZATION_ENGINE_CONTROLLER(31088),
